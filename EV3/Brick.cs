...
namespace MonoBrick.EV3
{
        ...
        where TSensor4 : Sensor, new()
    {
		...
		*/
        ...
        /// </value>
        public Motor MotorD { get; } = new Motor();

        /// <summary>
        /// Synchronise two motors
        /// </summary>
        /// <value>The motor sync.</value>
        public MotorSync MotorSync { get; } = new MotorSync();
        ...
        public void PlayTone(byte volume, ushort frequency, ushort durationMs)
        {
        ...
        /// <param name="durationMs">Duration in ms.</param>
        /// <param name="reply">If set to <c>true</c> reply from brick will be send</param>
        public void PlayTone(byte volume, ushort frequency, ushort durationMs, bool reply)
        {
        ...
        public void Beep(byte volume, ushort durationMs, bool reply)
        {
