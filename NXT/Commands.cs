...
namespace MonoBrick.NXT
{
    ...
    public class Reply : BrickReply
    {
        ...
        /// </value>
        public bool HasError => Convert.ToBoolean(ErrorCode);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Reply"/> class with no payload
        /// </summary>
        public Reply()
        {
        ...
        public Reply(byte[] data)
        {
            ...
            if (data.Length < 3)
            {
                throw new ArgumentException("Invalid NXT Reply");
            }
