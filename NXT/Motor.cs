...
namespace MonoBrick.NXT
{
    ...
    {
        internal MotorPort Port { get; set; } = MotorPort.OutA;
        internal Connection<Command, Reply> Connection { get; set; } = null;
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="Motor"/> run in reverse direction
        /// </summary>
        /// <value>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="Motor"/> is synchronised with another motor.
        ...
        public void SetOutputState(OutputState state, bool reply)
        {
            ...
            var command = new Command(CommandType.DirectCommand, CommandByte.SetOutputState, reply);
        ...
        /// If set to <c>true</c> the brick will send a reply
        /// </param>
        public void On(sbyte speed, uint degrees, bool reply)
        {
            OutputState state = new OutputState
            {
                Speed = speed,
                Mode = MotorMode.Break | MotorMode.On | MotorMode.Regulated,
                Regulation = MotorRegulation.Speed,
                TurnRatio = 100,
                RunState = MotorRunState.Running,
                TachoLimit = degrees
            };
        ...
        public void Off(bool reply)
        {
            ...
            {
                Speed = 0,
                Mode = MotorMode.Break | MotorMode.Regulated,
                Regulation = MotorRegulation.Speed,
                TurnRatio = 100,
                RunState = MotorRunState.Running,
                TachoLimit = 0
        ...
        public OutputState GetOutputState()
        {
            ...
            var command = new Command(CommandType.DirectCommand, CommandByte.GetOutputState, true);
            command.Append((byte)Port);
            Connection.Send(command);
        ...
        {
            var command = new Command(CommandType.DirectCommand, CommandByte.ResetMotorPosition, reply);
            command.Append((byte)Port);
        ...
        /// If set to <c>true</c> the brick will send a reply
        /// </param>
        public void MoveTo(byte speed, int position, bool reply)
        {
    ...
    {
        private readonly Motor left = new Motor();
        private readonly Motor right = new Motor();
        ...
        /// </param>
        public void Backward(sbyte speed) => Move((sbyte)-speed, 0, false);
        ...
        /// If set to <c>true</c> the brick will send a reply
        /// </param>
        public void Backward(sbyte speed, bool reply) => Move((sbyte)-speed, 0, reply);
        ...
        /// Speed of the vehicle -100 to 100
        /// </param>
        public void Forward(sbyte speed) => Move(speed, 0, false);
        ...
        /// If set to <c>true</c> the brick will send a reply
        /// </param>
        public void Forward(sbyte speed, bool reply) => Move(speed, 0, reply);
        ...
        /// Speed of the vehicle -100 to 100
        /// </param>
        public void SpinLeft(sbyte speed) => SpinLeft(speed, false);
        ...
        /// Speed of the vehicle -100 to 100
        /// </param>
        public void SpinRight(sbyte speed) => SpinRight(speed, false);
        ...
        /// Turn percent.
        /// </param>
        public void TurnRightReverse(sbyte speed, sbyte turnPercent) => TurnRightReverse(speed, turnPercent, false);
        ...
        /// Turn percent.
        /// </param>
        public void TurnLeftForward(sbyte speed, sbyte turnPercent) => TurnLeftForward(speed, turnPercent, false);
        ...
        /// Turn percent.
        /// </param>
        public void TurnLeftReverse(sbyte speed, sbyte turnPercent) => TurnLeftReverse(speed, turnPercent, false);
