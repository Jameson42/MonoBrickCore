...
namespace MonoBrick.NXT
{
...

    {
        ...
        private readonly byte[] brickName = { (byte)'s', (byte)'i', (byte)'m', (byte)'u', (byte)'l', (byte)'a', (byte)'t', (byte)'i', (byte)'o', (byte)'n' };
        private readonly byte[] bluetoothAddress = { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06 };
        private readonly uint flashSize = 4024;
        ...
        public override void Send(TBrickCommand command)
        {
            ...
            switch (((Command)nxtCommand).CommandByte)
            {
                ...
                case CommandByte.SetInputMode:
                    ...
                    reply = new Reply(CommandType.ReplyCommand, nxtCommand.CommandByte);
                    break;
