...
namespace MonoBrick.NXT
{
    ...
    {
        public ushort Raw;//device dependent
        public ushort Normalized;//type dependent
        public short Scaled;//mode dependent
    ...
    public class Sensor : ISensor
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Sensor"/> class with no sensor as type.
        /// </summary>
        public Sensor()
        {
            Mode = SensorMode.Raw;
        ...
        {
            var command = new Command(CommandType.DirectCommand, CommandByte.ResetInputScaledValue, reply);
        ...
        protected void UpdateTypeAndMode(SensorType sensorType, SensorMode sensorMode)
        {
            Type = sensorType;
            Mode = sensorMode;
            var command = new Command(CommandType.DirectCommand, CommandByte.SetInputMode, true);
            command.Append((byte)port);
        ...
        internal SensorReadings GetSensorReadings()
        {
            ...
            var command = new Command(CommandType.DirectCommand, CommandByte.GetInputValues, true);
            command.Append((byte)port);
        ...
        /// The scaled value 
        /// </returns>
        protected short GetScaledValue() => GetSensorReadings().Scaled;
        ...
        /// The raw value.
        /// </returns>
        protected ushort GetRawValue() => GetSensorReadings().Raw;
        ...
        /// </returns>
        protected ushort GetNormalizedValue() => GetSensorReadings().Normalized;
        ...
        /// </param>
        public virtual void Reset(bool reply) => ResetScaledValue(reply);
        ...
        /// </returns>
        public virtual string ReadAsString() => GetScaledValue().ToString();
        ...
        /// </value>
        public bool IsInitialized => hasInit;
        ...
        public static Dictionary<string, Sensor> SensorDictionary
        {
            get
            {
                ...
                {
                    { "None", new NoSensor() },
                    { "HiTechnic Color", new HiTecColor() },
                    { "HiTechnic Compass", new HiTecCompass() },
                    { "HiTechnic Gyro", new HiTecGyro(0) },
                    { "HiTechnic Tilt", new HiTecTilt() },
                    { "NXT Color", new NXTColorSensor() },
                    { "NXT Color Reflection Pct", new NXTColorSensor(SensorMode.Percent) },
                    { "NXT Color Reflection Raw", new NXTColorSensor(SensorMode.Raw) },
                    { "NXT Color Inactive Pct", new NXTColorSensor(ColorMode.None, SensorMode.Percent) },
                    { "NXT Color Inactive Raw", new NXTColorSensor(ColorMode.None, SensorMode.Raw) },
                    { "NXT Light Active Pct", new NXTLightSensor(LightMode.On, SensorMode.Percent) },
                    { "NXT Light Active Raw", new NXTLightSensor(LightMode.On, SensorMode.Raw) },
                    { "NXT Light Inactive Pct", new NXTLightSensor(LightMode.Off, SensorMode.Percent) },
                    { "NXT Light Inactive Raw", new NXTLightSensor(LightMode.Off, SensorMode.Raw) },
                    { "NXT Sonar Inch", new Sonar(SonarMode.CentiInch) },
                    { "NXT Sonar Metric", new Sonar(SonarMode.Centimeter) },
                    { "NXT Sound dBA", new NXTSoundSensor(SoundMode.SoundDBA) },
                    { "NXT Sound dB", new NXTSoundSensor(SoundMode.SoundDB) },
                    { "NXT/RCX Touch Bool", new TouchSensor(SensorMode.Bool) },
                    { "NXT/RCX Touch Raw", new TouchSensor(SensorMode.Raw) },
                    { "RCX Angle", new RCXRotationSensor() },
                    { "RCX Light Pct", new RCXLightSensor(SensorMode.Percent) },
                    { "RCX Light Raw", new RCXLightSensor(SensorMode.Raw) },
                    { "RCX Temp Celcius", new RCXTemperatureSensor(TemperatureMode.Celsius) },
                    { "RCX Temp Fahrenheit", new RCXTemperatureSensor(TemperatureMode.Fahrenheit) }
                };
                return dictionary;
            }
        }
    ...
    public class NoSensor : Sensor
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NoSensor"/> class.
        /// </summary>
    ...
    public class CustomSensor : Sensor
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomSensor"/> class  using custom sensor type and raw mode
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomSensor"/> class.
        /// </summary>
        /// <param name='type'>
        /// Sensor type
        /// </param>
    ...
    public class NXTColorSensor : Sensor
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NXTColorSensor"/> class as a color sensor.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NXTColorSensor"/> class as a light sensor.
        /// </summary>
        ...
        {
            set => UpdateTypeAndMode((SensorType)value, Mode);
            get => (ColorMode)Type;
        }
        ...
        {
            get => Mode;
            set => UpdateTypeAndMode(Type, value);
        }

        /// <summary>
        /// Read the intensity of the reflected light
        /// </summary>
        public int ReadLightLevel() => GetScaledValue();
        ...
        {
            return Type == SensorType.ColorFull && Mode == SensorMode.Raw
                ? ReadColor().ToString()
				: ReadLightLevel().ToString();
        }
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RCXLightSensor"/> class.
        /// </summary>
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RCXRotationSensor"/> class.
        /// </summary>
        ...
        /// </summary>
        public int ReadCount() => GetScaledValue();
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RCXTemperatureSensor"/> class as celsius
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RCXTemperatureSensor"/> class.
        /// </summary>
        ...
        {
            get => (TemperatureMode)Mode;
            set => UpdateTypeAndMode(Type, (SensorMode)value);
        }

        /// <summary>
        /// Read the temperature
        /// </summary>
        public int ReadTemperature() => GetScaledValue();
    }
    #endregion
    ...
    public class NXTSoundSensor : Sensor
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NXTSoundSensor"/> class in DBA mode.
        /// </summary>
        ...
        /// </summary>
        public int ReadSoundLevel() => GetScaledValue();
    }
    #endregion
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TouchSensor"/> class in bool mode
        /// </summary>
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HiTecGyro"/> class without offset
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HiTecGyro"/> class.
        /// </summary>
        /// <param name='offset'>
        /// Offset
        /// </param>
        ...
        /// </summary>
        public int ReadAngularAcceleration() => GetRawValue() - Offset;
        ...
        /// The value as a string.
        /// </returns>
        public override string ReadAsString() => ReadAngularAcceleration().ToString() + " deg/sec";
